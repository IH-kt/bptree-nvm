...
for memtype in ['pmem']: # ['vmem']: # ['pmem', 'vmem']:
    result_file_dirs_1 = get_logsz_dir('../' + memtype + '/elapsed_time/bptree_nvhtm_plain/')
    # result_file_dirs_2 = get_logsz_dir('../' + memtype + '/elapsed_time/bptree_nvhtm_1/')
    result_file_dirs_2 = get_logsz_dir('../' + memtype + '/elapsed_time/bptree_nvhtm_faw/')
    ...
    for i in range(len(result_file_dirs_1)):
        result_file_dir1 = '../' + memtype + '/elapsed_time/bptree_nvhtm_plain/' + result_file_dirs_1[i]
        # result_file_dir2 = '../' + memtype + '/elapsed_time/bptree_nvhtm_1/' + result_file_dirs_2[i]
        result_file_dir2 = '../' + memtype + '/elapsed_time/bptree_nvhtm_faw/' + result_file_dirs_2[i]
        ...
        plot_graph('scaling/' + memtype + '/' + result_file_dirs_1[i], result_file_dir1, result_file_dir2, "", "", ["NV-HTM", "NV-HTM(早めclwb)", "", ""], memtype)
