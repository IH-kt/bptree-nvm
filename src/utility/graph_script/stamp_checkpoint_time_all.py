...
def compare_logcomp(plot_infos):
    ...
    plot_infos['time_class'] = ['reserve', 'commit-finding', 'logwrite', 'apply-log-flush']
    ...
    plt.legend(plot_infos['labels'], bbox_to_anchor=(-0.3, -0.4), loc='center', borderaxespad=0, ncol=4)
...
def main():
    ...
    plot_infos['colorlst'] = ['#000000', '#888888', '#bbbbbb', '#ffffff']
    ...
    plot_infos['labels'] = ['initialization', 'log-select', 'log-write', 'log-apply']
