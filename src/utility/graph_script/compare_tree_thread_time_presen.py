...
def plot_graph(log_size_str, result_file1, result_file2, result_file3, result_file4, cols, memtype):
    ...
    for i in range(3):
        ...
        plt.savefig(log_size_str + '/' + colname.split('_concurrent.exe')[0] + '_presen_ja_2.pdf')
        plt.close()
...
for memtype in ['pmem']: # ['vmem']: # ['pmem', 'vmem']:
    ...
    for i in range(len(result_file_dirs_1)):
        ...
        plot_graph('scaling/' + memtype + '/' + result_file_dirs_1[i], result_file_dir1, result_file_dir2, result_file_dir4, result_file_dir3, ['NV-HTM', "DRAM利用", r"NV-HTMなし", "FPTree"], memtype)
