...
void NVHTM_shutdown()
{
    ...
    fprintf(stderr, "COMMIT : %i\n", successes);
    fprintf(stderr, "ABORTS : %i\n", s_aborts);
    fprintf(stderr, "CONFLS : %i\n", s_conflicts);
    fprintf(stderr, "CAPACS : %i\n", s_capacities);
    fprintf(stderr, "EXPLIC : %i\n", s_explicit_a);
    fprintf(stderr, "FALLBK : %i\n", fallbacks);
    ...
    fprintf(stderr, "AVG_CAP %f\n", used_cap / (double) nb_cap_samples);
    fprintf(stderr, "TOTAL_WRITES          %lli\n", MN_count_writes_to_PM_total);
    fprintf(stderr, "TOTAL_SPINS (workers) %lli\n", MN_count_spins_total);
    fprintf(stderr, "TOTAL_BLOCKS          %lli\n", NH_count_blocks_total);
    fprintf(stderr, "TOTAL_TIME_B (clocks) %llu\n", NH_time_blocked_total);
    fprintf(stderr, " ---   ----\n");
    fprintf(stderr, " ########################################### \n");
    fprintf(stderr, " ########################################### \n\n");
#else
